...
func (m *Manager) getDeliveryInterface(ifName string) string {
	...
	case m.sharedCfg.IPAM == ipamOption.IPAMENI ||
		...
		m.sharedCfg.IPAM == ipamOption.IPAMOCI: // add by dw
		return "lxc+"
...
func (m *Manager) installRules(ifName string) error {
	...
	if m.sharedCfg.IPAM == ipamOption.IPAMENI || m.sharedCfg.IPAM == ipamOption.IPAMAlibabaCloud || m.sharedCfg.IPAM == ipamOption.IPAMOCI {
