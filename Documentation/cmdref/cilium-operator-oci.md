...
Run cilium-operator-oci

```
cilium-operator-oci [flags]
```
...
```
  ...
  -h, --help                                      help for cilium-operator-oci
      ...
      --ipam string                               Backend to use for IPAM (default "oci")
      ...
      --oci-vcn-id string                         Specific VCN ID for OCI ENI. If not set use same VCN as operator
